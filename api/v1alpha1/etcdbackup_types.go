...
type S3BackupSource struct {
	...
	//The name of the secret object that stores the credential which will be used to access S3.
	//The secret must contain the following keys/fields:
	//    accessKeyID
	//    accessKeySecret
	S3Secret string `json:"s3Secret"`

	// Endpoint if blank points to aws. If specified, can point to S3 compatible object stores.
...
type OSSBackupSource struct {
	...
	// The name of the secret object that stores the credential which will be used to access
	// Alibaba Cloud OSS.
	//
	// The Secret must contain the following keys/fields:
	//     accessKeyID
